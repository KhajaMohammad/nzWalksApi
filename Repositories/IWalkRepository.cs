...
namespace nzWalksApi.Repositories
{
    public interface IWalkRepository
    {
        ...
        public Task<List<Walk>> GetAllAsync(string? filterOn = null , string? filterQuery = null, string? sortBy = null , bool isAscending= true, int pageNumber=1,int pageSize=1000);
